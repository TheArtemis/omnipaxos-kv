...
cd build_scripts
rm -f logs/history-1.json logs/history-2.json logs/merged-history.json logs/merged-history.html
...
cd ../verifier_amend
go run ./cmd/verifier --serve ../build_scripts/logs/history-1.json ../build_scripts/logs/history-2.json
```
