...
\begin{table}[h]
  ...
  \resizebox{0.95\textwidth}{!}{%
    \begin{tabular}{l r r r r r r r r l}
      ...
      adaptive\_deadline & 364 & 274 & 90 & 4.46 & 9.71 & 77.7 & 3.59 & 4.69 & PASS \\
...
Under the \emph{adaptive deadline} configuration, the system processes 364 operations, with 274 puts and 90 gets. The median latency is 4.46\,ms and the 95th percentile is 9.71\,ms. The fast-path ratio is 77.7\%, with average fast-path and slow-path latencies of 3.59\,ms and 4.69\,ms, respectively. These values indicate that percentile-based OWD estimation sustains a high fast-path ratio while keeping both fast- and slow-path latency averages relatively low. Still we don't see a major improvement with respect to fixed deadline.
